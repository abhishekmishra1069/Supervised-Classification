"""
Decision Tree Classification Web Application
This Flask application provides a web interface for predicting user purchasing behavior
using a trained Decision Tree classifier model.
"""
...
def load_model():
    ...
    Returns the classifier and scaler objects.
    """
    ...
    try:
        ...
        print(f"Error: {str(e)}")
        print("Please ensure pickle files are generated from decision_tree_classification.ipynb")
        return None, None
            ...
            function predict(event) {
                ...
                .then(data => {
                    ...
                    if (data.prediction === 1) {
                        resultDiv.textContent = 'Prediction: User will PURCHASE ✓';
                        resultDiv.className = 'purchased';
                    } else {
                        resultDiv.textContent = 'Prediction: User will NOT PURCHASE ✗';
...
def predict():
    ...
    try:
        ...
        return jsonify({
            ...
            'age': age,
            'salary': salary,
            'message': 'User will purchase' if prediction == 1 else 'User will not purchase'
        })
...
if __name__ == '__main__':
    ...
    if classifier is None or sc is None:
